...
public class Test_convertInt {
	 ...
	 *  
	 *  Example with sample code: https://www.geeksforgeeks.org/static-class-in-java/
	 *  
	 */
	...
	public void test1() throws Exception {
		assertEquals(Exception.class,testerConvertInt_1.new ConvertInt().convert(test1array));
	}
	...
	public void test2() throws Exception {
		assertEquals(Exception.class,testerConvertInt_2.new ConvertInt().convert(test2array));
	}
	...
	public void test3() throws Exception {
		assertEquals(Exception.class,testerConvertInt_3.new ConvertInt().convert(test3array));
	}
